...
let AdminController = class AdminController {
    ...
    async logout(dto, ip, req) {
        const userAgent = req.headers['user-agent'] || null;
        console.log(...oo_oo(`3846083059_97_4_97_41_4`, 'Logout Admin DTO:', dto));
        console.log(...oo_oo(`3846083059_98_4_98_34_4`, 'IP Address:', ip));
        console.log(...oo_oo(`3846083059_99_4_99_41_4`, 'User Agent:', userAgent));
