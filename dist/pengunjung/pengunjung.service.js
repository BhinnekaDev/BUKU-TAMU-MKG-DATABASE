...
let PengunjungService = class PengunjungService {
    ...
    async getAllStasiun() {
        ...
        if (error) {
            console.error(...oo_tx(`4270688037_66_6_66_53_11`, 'Error fetching stasiun:', error));
    ...
    async getJumlahPengunjung(id_stasiun) {
        ...
        try {
            ...
            if (hariIni.error || mingguIni.error || bulanIni.error) {
                console.error(...oo_tx(`4270688037_115_8_119_10_11`, 'Error fetching statistics:', {
            ...
            console.error(...oo_tx(`4270688037_131_6_131_70_11`, 'Unexpected error in getJumlahPengunjung:', error));
    ...
    async isiBukuTamu(dto, ip, userAgent, file) {
        ...
        try {
            ...
            if (error) {
                console.error(...oo_tx(`4270688037_239_8_239_58_11`, 'Error saat cek pengunjung:', error));
                throw new common_1.BadRequestException('Gagal mengecek data pengunjung');
            }
            ...
            if (existingPengunjung?.ID_Pengunjung) {
                ...
                if (pengunjungError) {
                    console.error(...oo_tx(`4270688037_264_10_264_73_11`, 'Error saat insert pengunjung:', pengunjungError));
                    throw new common_1.BadRequestException('Gagal menyimpan data pengunjung');
                }
            }
        }
        catch (err) {
            console.error(...oo_tx(`4270688037_269_6_269_70_11`, 'Unexpected error saat validasi pengunjung:', err));
            throw new common_1.BadRequestException('Gagal mengecek data pengunjung');
        }
    ...
    async searchPengunjung(dto) {
        ...
        if (errorDepan || errorBelakang) {
            console.error(...oo_tx(`4270688037_337_6_337_65_11`, 'Error search:', errorDepan || errorBelakang));
